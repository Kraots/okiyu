...
relationship_status_roles = {
    'ukiyo:relationship_status_roles:Single': 913789939668385822,
    'ukiyo:relationship_status_roles:Taken': 913789939961954304
}
...
class RelationshipStatusButtonRoles(disnake.ui.View):
    ...
    @disnake.ui.button(label='Single', custom_id='ukiyo:relationship_status_roles:Single', row=0, style=disnake.ButtonStyle.blurple)
    ...
    @disnake.ui.button(label='Taken', custom_id='ukiyo:relationship_status_roles:Taken', row=0, style=disnake.ButtonStyle.blurple)
