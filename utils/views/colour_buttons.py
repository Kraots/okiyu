...
class ColourButtonRoles(disnake.ui.View):
    ...
    @disnake.ui.button(label='Illusion', custom_id='okiyu:colour_roles:Illusion', emoji='<:illusion:886669987660574803>')
    ...
    @disnake.ui.button(label='Black', custom_id='okiyu:colour_roles:Black', emoji='<:black:886669987752841216>')
    ...
    @disnake.ui.button(label='Screaming Green', custom_id='okiyu:colour_roles:Screaming_Green', emoji='<:screaming_green:886669987769626636>')
    ...
    @disnake.ui.button(label='Electric Violet', custom_id='okiyu:colour_roles:Electric_Violet', emoji='<:electric_violet:886669987798986804>')
    ...
    @disnake.ui.button(label='Red Orange', custom_id='okiyu:colour_roles:Red_Orange', emoji='<:red_orange:886669987798999062>')
    ...
    @disnake.ui.button(label='Dodger Blue', custom_id='okiyu:colour_roles:Dodger_Blue', emoji='<:dodger_blue:886669987916427294>')
    ...
    @disnake.ui.button(label='Spring Green', custom_id='okiyu:colour_roles:Spring_Green', emoji='<:spring_green:886669987924815923>')
    ...
    @disnake.ui.button(label='Madang', custom_id='okiyu:colour_roles:Madang', emoji='<:madang:886669987991941181>')
    ...
    @disnake.ui.button(label='Perfume', custom_id='okiyu:colour_roles:Perfume', emoji='<:perfume:886669988008710174>')
    ...
    @disnake.ui.button(label='Ice Cold', custom_id='okiyu:colour_roles:Ice_Cold', emoji='<:ice_cold:886669988008710194>')
    ...
    @disnake.ui.button(label='Primrose', custom_id='okiyu:colour_roles:Primrose', emoji='<:primrose:886669988008718336>')
    ...
    @disnake.ui.button(label='Orchid', custom_id='okiyu:colour_roles:Orchid', emoji='<:orchid:886675375185350696>')
    ...
    @disnake.ui.button(label='Mandys Pink', custom_id='okiyu:colour_roles:Mandys_Pink', emoji='<:mandys_pink:886669988038062154>')
    ...
    @disnake.ui.button(label='Perano', custom_id='okiyu:colour_roles:Perano', emoji='<:perano:886669988063227965>')
    ...
    @disnake.ui.button(label='Turquoise', custom_id='okiyu:colour_roles:Turquoise', emoji='<:turquoise:886669988176470046>')
    ...
    @disnake.ui.button(label='Wewak', custom_id='okiyu:colour_roles:Wewak', emoji='<:wewak:886669988214243379>')
    ...
    @disnake.ui.button(label='Sunshade', custom_id='okiyu:colour_roles:Sunshade', emoji='<:sunshade:886669988289720410>')
    ...
    @disnake.ui.button(label='Broom', custom_id='okiyu:colour_roles:Broom', emoji='<:broom:886669989636100156>')
